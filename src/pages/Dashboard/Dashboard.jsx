      ...
      <div className="flex flex-col lg:flex-row gap-4 items-stretch mb-6">
        ...
        <div className="relative z-0 w-full lg:w-70 xl:w-75 2xl:w-[320px] shrink-0 rounded-[20px] bg-[#121212] overflow-hidden p-4 sm:p-5 flex flex-col justify-between gap-4 min-h-95 lg:min-h-111.5 lg:ml-0">
          ...
          <div className="relative flex items-center gap-2 z-10">
            <div className="flex items-center justify-center relative w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-[#FFFFFF12] overflow-hidden shrink-0">
          ...
          <div className="relative flex rounded-2xl border border-[#FFFFFF1A] p-0.5 bg-[#FFFFFF08] z-10">
            {[
              ...
              <button
                ...
                className={`relative flex items-center justify-center flex-1 h-9.5 rounded-[14px] gap-1.5 font-normal text-[11px] sm:text-[12px] leading-[150%] transition-colors cursor-pointer
          ...
          <div className="relative w-full rounded-2xl bg-[#FFFFFF08] p-3 z-10">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 z-10">
              <div className="w-35 sm:w-41.75 h-px bg-linear-to-r from-transparent via-[#9DEEFF] to-transparent opacity-70" />
            </div>
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex flex-col items-start gap-2 bg-[#1a1a1a] rounded-xl">
                <div
                  ref={trackRef}
                  className="relative w-full h-4.75 rounded-full bg-[#2b2b2b] overflow-hidden cursor-pointer select-none"
                ...
                >
                  ...
                  />
                  <div
                    className="absolute backdrop-blur-xs bg-[#14FCF21A] top-1/2 z-20 w-4.75 h-4.75 rounded-full flex items-center justify-center gap-0.5 cursor-grab active:cursor-grabbing"
