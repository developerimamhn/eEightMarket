...
import WideButton200 from '../components/button_svg/WideButton200';
import icon_8 from "../assets/icon_8.svg";
import Union from "../assets/Union.png";
import PurpleGlow from '../svg/PurpleGlow';
import CyanGlow from '../svg/CyanGlow';
          ...
          {tabs.map((item) => {
            ...
            return (
              <div key={item.name} className="flex items-center justify-center">
                {/* Active tab uses custom button style */}
