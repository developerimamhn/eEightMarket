...
//           <div
//             className={`flex items-center rounded-[16px] pl-3 pr-1 py-1 transition-all duration-200 ${
...
//               src={Bell}
//               alt="bell"
//               className="w-[48px] h-[48px] sm:w-14 sm:h-14 object-contain"
//             />
//           </button>
      ...
      <nav className="w-full px-4 sm:px-5 py-3 flex items-center justify-between relative z-50">
        ...
        <div className="flex items-center">
          ...
          <button className="w-[48px] h-[48px] flex items-center justify-center">
            <img src={Bell} className="w-[48px] h-[48px] object-contain" />
          </button>
