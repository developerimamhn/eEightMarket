...
//   >
//     <div
//       className={`w-[14px] h-[14px] rounded-full bg-[#00E8FF] transition-all duration-300
//         ${on ? "ml-auto" : "ml-0"}`}
//     />
//   </div>
// );
...
//     </span>
//     <span className={`label-span whitespace-nowrap transition ${active ? "text-white" : "text-white/70"}`}>
//       {label}
//     </span>
//   </button>
// );
...
// // Renders inside sidebar on mobile: Search bar + Account dropdown + User profile
...
//         <div
//           className="flex items-center flex-1 rounded-[14px] px-3 py-2.5"
...
//         {/* Bell */}
//         <button
//           className="flex items-center justify-center w-10 h-10 rounded-[12px] bg-white/[0.04]
//                      hover:bg-white/[0.08] transition-colors active:scale-95 shrink-0"
...
//           className="relative flex items-center justify-between w-full h-[44px] rounded-[14px] px-4
