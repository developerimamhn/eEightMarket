...
//   return (
//     <nav className="w-full bg-[#0a0d11]  px-5 py-3 flex items-center justify-between">

//       {/* Left: Search Bar with AI Button inside */}
//       <div className="flex items-center">
//   <div
//   className={`flex items-center rounded-lg px-3 py-1 transition-all duration-200 ${
//     searchFocused ? "w-[396px] border-white/30" : "w-[396px]"
//   }`}
//   style={{
//     background:
...
//   {/* AI Button */}
//   <button className="flex items-center justify-center shrink-0 ml-4">
//     <img
//       src={AiBtn}
//       alt="ai"
...
//         {/* Bell */}
//         <button className="w-[48px] h-[48px]  flex items-center rounded-[16px] justify-center">
...
//         {/* Account Selector */}
//       <button className="relative flex items-center justify-between w-[242px] h-[48px] rounded-[16px] px-[20px] bg-[#161817] text-white/70">
...
//   {/* Content */}
//   <span className="inline-block text-[16px] leading-[150%] font-normal text-white relative z-10">
...
//         {/* User Profile */}
//         <button className="flex items-center gap-2 pl-1 pr-3 py-1 bg-white/[0.04] rounded-sm hover:bg-white/[0.08] transition-all">
//           {/* Avatar - real photo */}
//           <img
//             src={userAvatar}
//             alt="James Carter"
//            className="w-[50px] h-[50px] rounded-xl object-cover object-center relative top-[-1px] shadow-[0_-1px_0_rgba(255,255,255,0.8)]"
//           />
...
//   return (
//     <>
//       <nav className="w-full bg-[#0a0d11] px-3 sm:px-5 py-3 flex items-center justify-between relative z-50">
...
//           {/* Bell */}
//           <button className="w-[40px] h-[40px] sm:w-[48px] sm:h-[48px] flex items-center rounded-[16px] justify-center">
//             <img
//               src={Bell}
//               alt="bell"
...
//           {/* User Profile */}
//           <button className="flex items-center gap-2 pl-1 pr-2 sm:pr-3 py-1 bg-white/[0.04] rounded-sm hover:bg-white/[0.08] transition-all">
//             <img
//               src={userAvatar}
//               alt="James Carter"
//               className="w-[40px] h-[40px] sm:w-[50px] sm:h-[50px] rounded-xl object-cover object-center relative top-[-1px] shadow-[0_-1px_0_rgba(255,255,255,0.8)]"
//             />
//             {/* Name/email — sm+ এ দেখাবে */}
...
//           {/* Mobile Menu Toggle (md এর নিচে দেখাবে) */}
//           <button
//             className="flex md:hidden items-center justify-center w-9 h-9 rounded-lg bg-white/[0.05] hover:bg-white/[0.10] transition-all"
...
//               placeholder="Search"
//               autoFocus
//               className="bg-transparent text-[13px] text-white/50 placeholder:text-base placeholder:text-white/35 outline-none flex-1"
//             />
...
//           {/* Account */}
//           <button className="relative flex items-center justify-between w-full h-[44px] rounded-[12px] px-4 bg-[#161817] text-white/70">
